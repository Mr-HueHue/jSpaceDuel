...
public class SFT_3DSImporter {
     ...
     */
    public SFT_Mesh importFromStream(InputStream inStream) {
     ...
     * @return
     */
    public SFT_Mesh makeMeshObject(ArrayList verts, ArrayList txtrs, ArrayList norms, ArrayList faces) {
        mesh = new SFT_Mesh(); // mesh object
        mesh.name = "3DS";
     ...
     * @return
     */
    public SFT_Triangle addTriangle(
            SFT_Mesh obj, SFT_Face face,
        ...
        if (norms.size() > 0) { // if normals were loaded
            ...
            t.norm1 = new SFT_Vector(norm[0], norm[1], norm[2]);
            norm = (float[]) norms.get(face.normalIDs[1]); // normal for vert 2
            t.norm2 = new SFT_Vector(norm[0], norm[1], norm[2]);
