...
public class SFT_Matrix {
     ...
     */
    public SFT_Matrix(SFT_Vector right, SFT_Vector up, SFT_Vector forward) {
        m00 = right.x;
        m10 = right.y;
        m20 = right.z;
        m01 = up.x;
     ...
     */
    public static SFT_Matrix translateMatrix(float dx, float dy, float dz) {
        SFT_Matrix m = new SFT_Matrix();
        m.m03 = dx;
        m.m13 = dy;
        m.m23 = dz;
        return m;
     ...
     */
    public static SFT_Matrix scaleMatrix(float dx, float dy, float dz) {
        SFT_Matrix m = new SFT_Matrix();
        m.m00 = dx;
        m.m11 = dy;
        m.m22 = dz;
     ...
     */
    public static SFT_Matrix scaleMatrix(float d) {
        return SFT_Matrix.scaleMatrix(d, d, d);
    }

    /**
     * create a rotation matrix
     */
    public static SFT_Matrix rotateMatrix(float dx, float dy, float dz) {
        SFT_Matrix out = new SFT_Matrix();
        float SIN;
        float COS;
     ...
     */
    public void transform(SFT_Matrix n) {
        SFT_Matrix m = this.getClone();
     ...
     */
    public void preTransform(SFT_Matrix n) {
        SFT_Matrix m = this.getClone();
     ...
     */
    public static SFT_Matrix multiply(SFT_Matrix m1, SFT_Matrix m2) {
        SFT_Matrix m = new SFT_Matrix();
     ...
     */
    public static void createBillboardMatrix(FloatBuffer matrix, SFT_Vector right, SFT_Vector up, SFT_Vector look, SFT_Vector pos) {
